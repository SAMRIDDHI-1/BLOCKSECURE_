...
export const FileUpload: React.FC<FileUploadProps> = ({ onFileUploaded }) => {
  ...
  return (
    <div className="relative bg-cyber-dark rounded-xl border border-cyber-border p-8 glow-border">
      {/* Corner accents */}
      <div className="absolute -top-3 -left-3 w-6 h-6 border-t-2 border-l-2 border-cyber-accent"></div>
      <div className="absolute -top-3 -right-3 w-6 h-6 border-t-2 border-r-2 border-cyber-blue"></div>

      {/* Header */}
      <div className="text-center mb-8">
        <div className="relative inline-flex items-center justify-center w-16 h-16 bg-cyber-card rounded-full mb-4 glow-border">
          <div className="absolute inset-0 bg-gradient-to-br from-cyber-blue to-cyber-purple opacity-20 rounded-full"></div>
          <Upload className="w-8 h-8 text-cyber-accent" />
        </div>
        <h2 className="text-2xl font-bold font-mono text-cyber-accent tracking-wider">
          <span className="text-cyber-blue">{">>"}</span> SECURE_UPLOAD
        </h2>
        <p className="text-cyber-text/80 font-mono text-sm tracking-wider">
          BLOCKCHAIN-VERIFIED_FILE_INTEGRITY
        </p>
      </div>
      ...
      <div
        className={`relative border-2 border-dashed rounded-lg p-8 transition-all ${
          dragActive 
            ? 'border-cyber-accent bg-cyber-card/50 shadow-glow' 
      ...
      >
        {uploading ? (
          <div className="text-center">
            <div className="relative inline-flex items-center justify-center w-12 h-12 bg-cyber-card rounded-full mb-4">
              <div className="absolute inset-0 bg-cyber-blue/10 rounded-full animate-pulse"></div>
              <Hash className="w-6 h-6 text-cyber-blue animate-spin" />
            </div>
            <p className="text-lg font-mono text-cyber-blue mb-2 tracking-wider">
              PROCESSING_FILE
            </p>
            <p className="text-xs font-mono text-cyber-text/80 tracking-wider">
              {uploadProgress}
            </p>
            <div className="w-full bg-cyber-card rounded-full h-1.5 mt-4 overflow-hidden">
              <div 
                className="bg-gradient-to-r from-cyber-blue to-cyber-purple h-full rounded-full transition-all duration-300"
                style={{ width: `${uploadProgress.includes('COMPLETE') ? '100%' : '75%'}` }}
              ></div>
            </div>
          </div>
          ...
          <div className="text-center">
            <File className="mx-auto h-12 w-12 text-cyber-text/50 mb-4" />
            <div className="mb-6">
              <p className="text-lg font-mono text-cyber-blue mb-1 tracking-wider">
                DROP_FILE_TO_UPLOAD
              </p>
              <p className="text-xs font-mono text-cyber-text/50 tracking-wider">
                ALL_FILE_TYPES • MAX_10MB
              </p>
            </div>
            <input
            ...
            <label
              htmlFor="file-upload"
              className="relative inline-flex items-center px-6 py-3 bg-cyber-card text-cyber-blue font-mono text-sm tracking-wider rounded-lg border border-cyber-blue/30 hover:bg-cyber-blue/10 hover:shadow-glow-sm transition-all cursor-pointer group"
            >
              <span className="relative z-10 flex items-center">
                <Upload className="w-4 h-4 mr-2 text-cyber-accent" />
                INITIATE_UPLOAD
              </span>
              <span className="absolute inset-0 border border-cyber-blue rounded-lg translate-x-1 translate-y-1 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform"></span>
            </label>
          </div>
        )}
      </div>
      ...
      <div className="absolute -bottom-3 -left-3 w-6 h-6 border-b-2 border-l-2 border-cyber-purple"></div>
      <div className="absolute -bottom-3 -right-3 w-6 h-6 border-b-2 border-r-2 border-cyber-accent"></div>
    </div>
  );
};