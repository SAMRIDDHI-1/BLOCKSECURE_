...
export const FileVerification: React.FC = () => {
  ...
  return (
    <div className="relative bg-gray-900 rounded-xl border border-cyan-400/20 p-8 shadow-lg shadow-cyan-500/10">
      {/* Glowing background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-cyan-500/10 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-96 h-96 bg-purple-500/10 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">File Verification</h2>
          <p className="text-gray-400">Verify file integrity against blockchain records</p>
        </div>
        ...
        >
          {verifying ? (
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-cyan-500/20 rounded-full mb-4 animate-spin">
                <Search className="w-6 h-6 text-cyan-400" />
              </div>
              <p className="text-lg font-medium text-white mb-2">Verifying File</p>
              <p className="text-sm text-gray-400">Checking blockchain records...</p>
            </div>
          ) : (
            <div className="text-center">
              ...
              <label
                htmlFor="verify-upload"
                className="relative inline-flex items-center px-6 py-3 bg-gray-800 text-white font-medium rounded-lg border border-cyan-400/30 hover:bg-gray-700 hover:shadow-cyan-400/10 transition-all cursor-pointer group"
              >
                <span className="relative z-10 flex items-center">
                  <Search className="w-4 h-4 mr-2 text-cyan-400" />
                  Select File to Verify
                </span>
                <span className="absolute inset-0 border border-cyan-400 rounded-lg translate-x-1 translate-y-1 group-hover:translate-x-0 group-hover:translate-y-0 transition-transform"></span>
              </label>
            </div>
          )}
        </div>
          ...
          <div className="mt-8">
            <div className={`rounded-lg p-6 border-2 ${
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className={`text-lg font-bold ${
                    verificationResult.isValid ? 'text-cyan-400' : 'text-red-400'
                  }`}>
                    {verificationResult.isValid ? 'File Verified' : 'Verification Failed'}
                  </h3>
                  <p className={`text-sm ${
                    verificationResult.isValid ? 'text-cyan-400/80' : 'text-red-400/80'
                  }`}>
                    {verificationResult.isValid 
                      ? 'File integrity confirmed by blockchain' 
                      : 'File has been tampered with or not found'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-3">
                  ...
                  <code className="block bg-gray-800 p-2 rounded border border-gray-700 text-xs text-gray-300 break-all">
                    {verificationResult.currentHash}
                  </code>
                </div>
              ...
              {verificationResult.blockchainRecord && (
                <div className="mt-4 pt-4 border-t border-gray-700">
                  <h4 className="font-medium text-white mb-2">Blockchain Record:</h4>
              ...
              {verificationResult.tamperDetails && (
                <div className="mt-4 pt-4 border-t border-red-400/30">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-red-400 mb-2">Tampering Detected:</h4>
